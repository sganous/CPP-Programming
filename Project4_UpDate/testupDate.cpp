...
int main()
{
	...
	cout << "The very first Julian date was " << upDate(4, 5, 2016) - upDate(4, 5, 2016).julian() << endl;
	...
	upDate springBreak(3, 28, 2016);

	cout << "Spring Break starts " << springBreak << endl;
